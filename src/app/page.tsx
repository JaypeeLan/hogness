          ...
          <div className="container">
            <div className={`${styles.heroContent} anim`}>
              ...
              <h1 className={styles.heroH1}>
               <span> Build Future-Ready Tech
                Skills That </span> Open New
                Opportunities
              </h1>
              <p className={styles.heroDesc}>
                At Hogens Technologies Ltd, we make technology simple, practical, and accessible. Whether you want to
                explore data, understand AI, or start coding, our hands-on programs help you learn with confidence.
              </p>
